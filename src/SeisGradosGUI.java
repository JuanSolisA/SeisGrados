...
public class SeisGradosGUI extends JFrame {
    ...
    // Constructor
    public SeisGradosGUI() {
        // Configuración básica de la GUI
        setTitle("Seis Grados de Separación");
        setSize(400, 300);
    ...
    private void conectarBaseDeDatos() {
        try {
            ...
            String user = "root";
            String password = "";  // Asegurate de poner tu contraseña de MySQL
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            SeisGradosGUI gui = new SeisGradosGUI();
            gui.setVisible(true);
        });
    }
}
